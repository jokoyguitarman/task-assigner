-- Simple fix for outlet deletion
-- This script will help identify and resolve outlet deletion issues

-- First, check what's preventing the outlet deletion
...
-- Option 1: Set them to NULL (if the column allows NULL)
-- Option 2: Set them to a different outlet ID
-- Option 3: Delete the referencing records first
